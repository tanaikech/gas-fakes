...
- **gf_agent Knowledge Base**: Added `14-utilities-parity.md` to capture specific API parity constraints around Apps Script's `Utilities` service for better code generation.
