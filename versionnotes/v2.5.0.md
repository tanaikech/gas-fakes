# gas-fakes v2.5.0 Release Notes

## Overview

Version 2.5.0 introduces a massive upgrade to local development capabilities: a built-in local web server and full emulation of Google Apps Script's HTML Service and UI framing. 
