...
- `setTransposeRowsAndColumns(Boolean)`
- `setXAxisLogScale()`
- `setXAxisRange(Number,Number)`
- `setXAxisTextStyle(TextStyle)`
- `setXAxisTitle(String)`
- `setXAxisTitleTextStyle(TextStyle)`
- `setYAxisLogScale()`
- `setYAxisRange(Number,Number)`
- `setYAxisTextStyle(TextStyle)`
- `setYAxisTitle(String)`
- `setYAxisTitleTextStyle(TextStyle)`
...
- `enablePaging(Integer,Integer)`
- `enablePaging(Integer)`
- `enableRtlTable(Boolean)`
...
- `removeRange(Range)`
- `setChartType(ChartType)`
- `setFirstRowNumber(Integer)`
- `setHiddenDimensionStrategy(ChartHiddenDimensionStrategy)`
- `setInitialSortingAscending(Integer)`
- `setInitialSortingDescending(Integer)`
- `setMergeStrategy(ChartMergeStrategy)`
- `setNumHeaders(Integer)`
- `setOption(String,Object)`
- `setPosition(Integer,Integer,Integer,Integer)`
...
- `useAlternatingRowStyle(Boolean)`
