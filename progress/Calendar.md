...
| [deleteCalendar()](https://developers.google.com/apps-script/reference/calendar/calendar#deleteCalendar()) | Deletes the calendar permanently. A user can only delete a calendar they own. |  |  | completed | [link](../src/services/calendarapp/fakecalendar.js#L84) |
