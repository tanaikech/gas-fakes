...
| [getContentType()](https://developers.google.com/apps-script/reference/base/blob#getContentType()) | Gets the content type of the bytes in this blob. | String\|null | The content type of this data, if known, or null. | completed | [link](../src/services/utilities/fakeblob.js#L51) |
...
| [inputBox(String)](https://developers.google.com/apps-script/reference/base/browser#inputBox(String)) | Pops up a dialog box with a text input box in the user's browser. | String\|null | The text entered by the user (or 'cancel' for a canceled or dismissed dialog). | not started |  |
...
| [msgBox(String)](https://developers.google.com/apps-script/reference/base/browser#msgBox(String)) | Pops up a dialog box with the given message and an OK button in the user's browser. | String\|null | The lower case text of the button that is clicked by the user (or 'cancel' for a dismissed dialog). | not started |  |
