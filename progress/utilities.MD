...
| [parseCsv(String,Char)](https://developers.google.com/apps-script/reference/utilities/utilities#parseCsv(String,Char)) |  |  |  | completed | [link](../src/services/utilities/fakeutilities.js#L503) |
| [parseCsv(String)](https://developers.google.com/apps-script/reference/utilities/utilities#parseCsv(String)) | Returns a tabular 2D array representation of a CSV string. | String[][] | A two-dimensional array containing the values in the CSV string. | completed | [link](../src/services/utilities/fakeutilities.js#L503) |
| [parseDate(String,String,String)](https://developers.google.com/apps-script/reference/utilities/utilities#parseDate(String,String,String)) |  |  |  | completed | [link](../src/services/utilities/fakeutilities.js#L564) |
