...
| [getIndex()](https://developers.google.com/apps-script/reference/forms/grid-item#getIndex()) | Gets the index of the item among all the items in the form. | Integer | the index of the item | completed | [link](../src/services/formapp/fakeformitem.js#L120) |
...
| [getIndex()](https://developers.google.com/apps-script/reference/forms/scale-item#getIndex()) | Gets the index of the item among all the items in the form. | Integer | the index of the item | completed | [link](../src/services/formapp/fakeformitem.js#L120) |
...
| [setTitle(String)](https://developers.google.com/apps-script/reference/forms/scale-item#setTitle(String)) | Sets the item's title (sometimes called header text, in the case of a SectionHeaderItem). | [ScaleItem](#class-scaleitem) | this ScaleItem, for chaining | completed | [link](../src/services/formapp/fakeformitem.js#L190) |
...
| [setTitle(String)](https://developers.google.com/apps-script/reference/forms/time-item#setTitle(String)) | Sets the item's title (sometimes called header text, in the case of a SectionHeaderItem). | [TimeItem](#class-timeitem) | this TimeItem, for chaining | completed | [link](../src/services/formapp/fakeformitem.js#L190) |
...
| [setTitle(String)](https://developers.google.com/apps-script/reference/forms/video-item#setTitle(String)) | Sets the item's title (sometimes called header text, in the case of a SectionHeaderItem). | [VideoItem](#class-videoitem) | this VideoItem, for chaining | completed | [link](../src/services/formapp/fakeformitem.js#L190) |
